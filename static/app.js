...
function diffText() {
    ...
    if (counter == 0){
    text = "Cost: 56,978,180 CR.  Landing Pad: Medium.  Poilot Seats: 2.  Hull Mass: 350t.  Armour: 468.  Shields: 294 MJ.  Fuel capacity: 32t.  HARDPOINTS: 4x utillity mounts.  2x Medium hardpoints.  3x Large hardpoints.  INTERNAL COMPARTMENTS: 1x class 1 compartment.  1x class 2 compartment.  2x class 3 compartments.  1x class 4 compartment.  2x class 5 compartments.  3x class 6 compartments." 
...
function diffTextb() {
    if (counter == 0){
    text = "Cost: 19,382,250 CR.  Landing Pad: Medium.  Poilot Seats: 2.  Hull Mass: 400t.  Armour: 504.  Shields: 162 MJ.  Fuel capacity: 16t.  HARDPOINTS: 4x utillity mounts. 3x small Hardpoints  1x Medium hardpoint.  2x Large hardpoints.  INTERNAL COMPARTMENTS: 1x class 1 compartment.  2x class 2 compartments.  1x class 4 compartment.  1x class 5 compartment.  1x class 6 compartments.  3x class 4 Military compartments." 
    ...
    function diffTextc() {
        if (counter == 0){
        text = "Cost: 6,661,153 CR.  Landing Pad: Medium.  Poilot Seats: 2.  Hull Mass: 280t.  Armour: 378.  Shields: 152 MJ.  Fuel capacity: 32t.  HARDPOINTS: 4x utillity mounts. 4x small Hardpoints  2x Medium hardpoints.  INTERNAL COMPARTMENTS: 1x class 1 compartment.  2x class 2 compartments. 3x class 3 compartments.  1x class 5 compartment.  1x class 6 compartments." 
        ...
        function diffTextd() {
            if (counter == 0){
            text = "Cost: 146,969,450 CR.  Landing Pad: Large.  Poilot Seats: 3.  Hull Mass: 400t.  Armour: 945.  Shields: 362 MJ.  Fuel capacity: 32t.  HARDPOINTS: 8x utillity mounts. 2x small Hardpoints  2x Medium hardpoints. 3x Large hardpoints.  1x Huge hardpoint.  INTERNAL COMPARTMENTS: 1x class 1 compartment.  1x class 2 compartment. 3x class 4 compartments.  3x class 5 compartment.  3x class 6 compartments.  1x class 7 compartments. 1x class 5 Military compartment." 
            ...
            function diffTexte() {
                if (counter == 0){
                text = "Cost: 208,969,451 CR.  Landing Pad: Large.  Poilot Seats: 3.  Hull Mass: 1,100t.  Armour: 720.  Shields: 704 MJ.  Fuel capacity: 64t.  HARDPOINTS: 8x utillity mounts.  4x Medium hardpoints. 2x Large hardpoints.  1x Huge hardpoint.  INTERNAL COMPARTMENTS: 1x class 1 compartment.  1x class 3 compartment. 1x class 4 compartment.  2x class 5 compartment.  3x class 6 compartments.  2x class 8 compartments. 2x class 5 Military compartment." 
